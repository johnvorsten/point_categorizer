# -*- coding: utf-8 -*-
"""
Created on Tue Sep 24 21:21:58 2019
...
First impressions : 
The loss and NDCG metric seem to level off relatively quickly

Some things to try : 
1)
Embed label space - see tensorflow documentation for encoded feature space tip
2)
...
"""
_iter_track = 0 # delete this

# Store the paths to files containing training and test instances.
_TRAIN_DATA_PATH = "./data/JV_train_reciprocal.tfrecords"
_TEST_DATA_PATH = "./data/JV_test_reciprocal.tfrecords"
...
#_MODEL_DIR = os.path.join(r"C:\Users\z003vrzk\.spyder-py3\Scripts\ML\Point database categorizer\TF_Logs\ranking_model_dir")
_now = datetime.utcnow().strftime('%Y%m%d%H%M%S')
_name = 'Run_' + _now + 'model1'
_MODEL_DIR = os.path.join(r"TF_Logs\ranking_model_dir", _name)
_NUM_TRAIN_STEPS = 2000
