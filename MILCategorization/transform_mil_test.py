...
def test_mil_transform_pipeline():
    ...
    categorical_transform_pipeline_MIL = Transform.categorical_transform_pipeline_MIL()
    numeric_transform_pipeline_MIL = Transform.numeric_transform_pipeline_MIL()
